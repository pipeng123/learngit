...
void UART_Initialization(void)
{
  ((((UART_MemMapPtr)0x4006A000u))->R1)     = (((unsigned char)((32768 * 640) / (16*115200))>>8)&0x1f);
  ((((UART_MemMapPtr)0x4006A000u))->R2)     = ((unsigned char)((32768 * 640) / (16*115200))&0xff);
  ((((UART_MemMapPtr)0x4006A000u))->R4)      = 0x8u|0x4u;

  while((((((UART_MemMapPtr)0x4006A000u))->R5) & 0x20u))
  (void)UART_GetChar();
}
...
void UART_PutChar(unsigned char data)
{
  while((((((UART_MemMapPtr)0x4006A000u))->R5)&0x40u) == 0){}; 
  ((((UART_MemMapPtr)0x4006A000u))->R8) = data;
}
...
unsigned char UART_GetChar(void)
{
  while((((((UART_MemMapPtr)0x4006A000u))->R5) & 0x20u) == 0){

		
};
  
  return ((((UART_MemMapPtr)0x4006A000u))->R8);
}
